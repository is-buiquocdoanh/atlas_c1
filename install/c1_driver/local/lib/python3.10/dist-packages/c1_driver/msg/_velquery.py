...
class Metaclass_Velquery(type):
    """Metaclass of message 'Velquery'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'c1_driver.msg.Velquery')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__velquery
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__velquery
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__velquery
            cls._TYPE_SUPPORT = module.type_support_msg__msg__velquery
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__velquery
...
class Velquery(metaclass=Metaclass_Velquery):
    """Message class 'Velquery'."""
    ...
    def byte0(self, value):
        if __debug__:
            ...
            assert value >= -32768 and value < 32768, \
                "The 'byte0' field must be an integer in [-32768, 32767]"
        self._byte0 = value
    ...
    def byte1(self, value):
        if __debug__:
            ...
            assert value >= -32768 and value < 32768, \
                "The 'byte1' field must be an integer in [-32768, 32767]"
        self._byte1 = value
    ...
    def byte2(self, value):
        if __debug__:
            ...
            assert value >= -32768 and value < 32768, \
                "The 'byte2' field must be an integer in [-32768, 32767]"
        self._byte2 = value
    ...
    def byte3(self, value):
        if __debug__:
            ...
            assert value >= -32768 and value < 32768, \
                "The 'byte3' field must be an integer in [-32768, 32767]"
        self._byte3 = value
    ...
    def byte4(self, value):
        if __debug__:
            ...
            assert value >= -32768 and value < 32768, \
                "The 'byte4' field must be an integer in [-32768, 32767]"
        self._byte4 = value
    ...
    def byte5(self, value):
        if __debug__:
            ...
            assert value >= -32768 and value < 32768, \
                "The 'byte5' field must be an integer in [-32768, 32767]"
        self._byte5 = value
    ...
    def byte6(self, value):
        if __debug__:
            ...
            assert value >= -32768 and value < 32768, \
                "The 'byte6' field must be an integer in [-32768, 32767]"
        self._byte6 = value
    ...
    def byte7(self, value):
        if __debug__:
            ...
            assert value >= -32768 and value < 32768, \
                "The 'byte7' field must be an integer in [-32768, 32767]"
        self._byte7 = value
