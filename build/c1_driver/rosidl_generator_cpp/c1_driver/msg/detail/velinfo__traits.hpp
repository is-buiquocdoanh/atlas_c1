...
#ifndef C1_DRIVER__MSG__DETAIL__VELINFO__TRAITS_HPP_
#define C1_DRIVER__MSG__DETAIL__VELINFO__TRAITS_HPP_
  ...
  std::ostream & out)
{
  ...
  {
    out << "idsend: ";
    rosidl_generator_traits::value_to_yaml(msg.idsend, out);
    out << ", ";
  }
...
inline std::string to_yaml(const Velinfo & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const c1_driver::msg::Velinfo & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const c1_driver::msg::Velinfo & msg)
{
  return c1_driver::msg::to_yaml(msg);
}

template<>
inline const char * data_type<c1_driver::msg::Velinfo>()
{
  return "c1_driver::msg::Velinfo";
}

template<>
inline const char * name<c1_driver::msg::Velinfo>()
{
  return "c1_driver/msg/Velinfo";
}

template<>
struct has_fixed_size<c1_driver::msg::Velinfo>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<c1_driver::msg::Velinfo>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<c1_driver::msg::Velinfo>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // C1_DRIVER__MSG__DETAIL__VELINFO__TRAITS_HPP_
