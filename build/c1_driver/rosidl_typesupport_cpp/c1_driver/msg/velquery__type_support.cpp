...
static const _Velquery_type_support_symbol_names_t _Velquery_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, c1_driver, msg, Velquery)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, c1_driver, msg, Velquery)),
  }
};
...
{
  return &::c1_driver::msg::rosidl_typesupport_cpp::Velquery_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, c1_driver, msg, Velquery)() {
  return get_message_type_support_handle<c1_driver::msg::Velquery>();
}
